...
public class SvPago extends HttpServlet {
    ...
    //Variable donde se guardara la identifiacion del usaurio temporalmente
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (idMembresia != null) {
            ...
            Membresia membresiaPago = controladorMembresia.buscarMembresiaId(listaMembresias, Integer.parseInt(idMembresia));
            //LLamado al metodo para realizar el pago 
            controladorUsuario.realizarPago(identificacion, idMembresia, listaUsuarios, membresiaPago, context);
